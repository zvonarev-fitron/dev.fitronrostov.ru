    ...
    <div class="cabinet_container_content">
        <div class="cabinet_container_content_menu">
            <ul>
                ...
                <li>
                    <a href="/cabinet">Депозит</a>
                </li>
                <li>
                    <a href="/cabinet">Мои услуги</a>
                </li>
                <li>
                    <a href="/cabinet">Бонус</a>
                </li>
                <li>
                    <a href="/cabinet">Тренеры</a>
                </li>
                <li>
                    <a href="/cabinet">Сообщения (2)</a>
                </li>
                <li>
                    <a href="/cabinet">Обратнаяч связь</a>
                </li>
