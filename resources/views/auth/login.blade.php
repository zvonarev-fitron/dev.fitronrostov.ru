        ...
        <div class="container">
            ...
            <ul class="uk-breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                ...
                <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" class="uk-active">
                    <span itemprop="name">Авторизоваться</span>
                </li>
            </ul>
        </div>
    </div>
...
<section class="container">
    <div class="login">
        ...
        <form method="post" action="{{ route('login') }}">
            @csrf
            <p>
                <input type="tel" id="form_login_phone" name="phone" value="{{old('phone')}}" placeholder="{{__('Телефон')}}">
                @if ($errors->has('phone'))
            ...
            <p>
                <input type="password" name="password" value="" placeholder="{{__('Пароль')}}">
            ...
            <p class="submit"><input type="submit" name="login" value="{{__('Войти')}}"></p>
        </form>
    </div>
</section>
@endsection

@section('mainnnnnnnnnn')
<div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-sm-4 col-form-label text-md-right">{{ __('Номер телефона') }}</label>
